...
namespace xblah_modding_tool
{
    public partial class ChaptersForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void createChapterTitles()
        {
            ...
            xblah_modding_lib.KeyValue.writeChunkFile(filePath, root, Encoding.Unicode);
        }
        ...
        private void readChapterBackgrounds()
        {
            ...
            {
                xblah_modding_lib.KeyValue chapters = xblah_modding_lib.KeyValue.readChunkfile(filePath);
        ...
        private void readChapterTitles()
        {
            ...
            if(File.Exists(filePath))
            {
                lang = xblah_modding_lib.KeyValue.readChunkfile(filePath);
                xblah_modding_lib.KeyValue tokens = lang.getChildByKey("tokens");
                for(int i = 0; i < chapters.Count; i++)
                {
        ...
        private void writeChapterBackgrounds()
        {
            ...
            xblah_modding_lib.KeyValue.writeChunkFile(filePath, root, false);
        }
