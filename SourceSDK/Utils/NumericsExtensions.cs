using SourceSDK.Utils.Precision;
using System;
...
namespace SourceSDK.Utils
{
    public static class NumericsExtensions
    {
        ...
        public static PrecisionVector3 ToPrecisionVector3(this Vector3 self)
        {
            return new PrecisionVector3(self.X, self.Y, self.Z);
        }
